    ...
    fun `calculateCost should return 0 when users have identical preferences and info`() {
        val user1 = User(
            ...
            info = Info(
                ...
                age = 20,
                description = "",
                sleepSchedule = Pair("22:00", "22:00"),
